...
const Navbar = () => {
  return (
    <div className="snap-start navbar bg-base-100 font-[poppins]  dark:bg-[#0F0F0F]">
  ...
  <div className="navbar-center hidden lg:flex p-4">
    <ul className="menu menu-horizontal space-x-8 md:text-xl dark:text-white">
      <li><Link to='/'>Home</Link></li>
      <li><Link to='/'>For interns</Link></li>
      <li><Link to='/hire'>For companies</Link></li>
      <li><Link to='/about'>About</Link></li>
  ...
  <div className="navbar-end flex gap-4">
    <Link to='/login' className="btn bg-black dark:bg-white dark:text-black text-white rounded-2xl w-20">Login</Link>
    <Link to='/signup' className="btn bg-black dark:bg-white dark:text-black text-white rounded-2xl w-20">Signup</Link>
    <ToggleBtn/>
  </div>
</div>
  )
