...
const Navbar_1 = () => {
  return (
    <div className="snap-start navbar font-[poppins] shadow-lg dark:bg-[#0F0F0F]">
    ...
    <div className="navbar-center hidden lg:flex p-4">
      <ul className="menu menu-horizontal space-x-16 md:text-xl text-black dark:text-white">
        <li><Link to='/'>Home</Link></li>
        <li><Link to='/inbox'>Inbox</Link></li>
        <li><Link to='/about'>About</Link></li>
        <li><Link to='/contact'>Contact us</Link></li>
