...
const Navbar_3 = () => {
  return (
    <div className="snap-start navbar font-[poppins] dark:bg-[#0F0F0F]">
    ...
    <div className="navbar-center hidden lg:flex p-4">
      <ul className="menu menu-horizontal px-1 space-x-8 md:text-xl text-black dark:text-white">
        <li><Link to='/'>Home</Link></li>
        <li><Link to='/about'>About</Link></li>
        <li><Link to='/contact'>Contact us</Link></li>
      </ul>
    ...
    <Link to='/login' className="btn bg-black text-white rounded-2xl w-20 dark:bg-white dark:text-black">Login</Link>
    <Link to='/signup' className="btn bg-black text-white rounded-2xl w-20 dark:bg-white dark:text-black">Signup</Link>
  </div>
  </div>
  )
}
