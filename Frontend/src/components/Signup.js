...
const signup = process.env.REACT_APP_BASE_URL + "/users/register";
          ...
          <div className="md:max-w-md w-full sm:px-6 py-4">
            <form onSubmit={handleSignup}>
              ...
              {/* <div class="relative inline-flex items-center justify-center w-full">
                ...
                <span class="mb-4 absolute px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">
                  OR
                </span>
              </div> */}
              <div>
