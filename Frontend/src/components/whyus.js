                ...
                <div className="absolute inset-0 h-full w-full rounded-xl px-12 text-center bg-white text-black [transform:rotateY(180deg)] [backface-visibility:hidden]">
                  <div className="flex min-h-full flex-col items-center justify-center">
                    <h1>
                      ...
                      Distinctio in placeat nemo esse dicta doloribus ab saepe
                      voluptates obcaecati, impedit delectus. Illum libero, a
                      quae nulla voluptatem sint ab quasi!
                    </h1>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-full w-full rounded-3xl shadow-xl bg-white text-black [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] [backface-visibility:hidden] transition-all duration-1000">
                ...
                <div className="absolute inset-0 h-full w-full rounded-xl px-12 text-center bg-white text-black [transform:rotateY(180deg)] [backface-visibility:hidden]">
                  <div className="flex min-h-full flex-col items-center justify-center">
                    <h1>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Eligendi quaerat, temporibus esse autem excepturi quam
                      numquam nemo, vel, necessitatibus voluptate exercitationem
                      quia officia consequuntur doloribus quasi tempora.
                      Consectetur, veniam ducimus?
                    </h1>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-full w-full rounded-3xl bg-white text-black shadow-xl [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] [backface-visibility:hidden] transition-all duration-1000">
                ...
                <div className="absolute inset-0 h-full w-full rounded-xl px-12 text-center bg-white text-black [transform:rotateY(180deg)] [backface-visibility:hidden]">
                  <div className="flex min-h-full flex-col items-center justify-center">
                    <h1>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Doloremque vitae inventore, ducimus nam, voluptatibus
                      aspernatur expedita debitis ullam quo perspiciatis a
                      quaerat! Fugiat similique maxime harum quia libero
                      nesciunt natus!
                    </h1>
                  </div>
                </div>
